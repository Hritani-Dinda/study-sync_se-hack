...
const CarouselNavButton = React.forwardRef<
  HTMLButtonElement,
  { direction: "prev" | "next" } & React.ComponentProps<typeof Button>
>(
  (
    { direction, className, variant = "outline", size = "icon", ...props },
    ref
  ) => {
    const {
      orientation,
...
export {
  ...
  CarouselContent,
  CarouselItem,
  CarouselNavButton as CarouselPrevious,
  CarouselNavButton as CarouselNext,
};
