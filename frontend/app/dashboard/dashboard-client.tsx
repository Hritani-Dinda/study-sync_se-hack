                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="text-sm text-muted-foreground">
                          {isPresent ? "Marked at 9:30 AM" : "Not marked"}
                        </div>
                      </div>
                    );
                  })}
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {[
                        { course: "Database Systems", attendance: 90 },
                        { course: "Operating Systems", attendance: 85 },
                        { course: "Computer Networks", attendance: 80 },
                        { course: "Software Engineering", attendance: 95 },
                      ].map((item, i) => (
                        <div key={i}>
                          ...
                          <Progress value={item.attendance} className="h-1" />
                        </div>
                      ))}
                    </div>
                  </div>
