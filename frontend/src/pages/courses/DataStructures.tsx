          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              ...
              <ul className="space-y-2">
                <li>• 16 Weeks Duration</li>
                <li>• 6 Projects</li>
                <li>• 32 Hours of Content</li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Prof. Lovelace is a leading expert in algorithms and data
              structures with over 15 years of teaching experience. She has
              published numerous papers on algorithm optimization.
            </p>
